...
CLEAN_DATA_USD = "update usd_figis set LONG_OR_SHORT = NULL where LONG_OR_SHORT IS NOT NULL"
CLEAN_DATA_RUS = "update rus_figis set LONG_OR_SHORT = NULL where LONG_OR_SHORT IS NOT NULL"
...
async def main():
    await clean_data(CLEAN_DATA_RUS)
    await clean_data(CLEAN_DATA_USD)
